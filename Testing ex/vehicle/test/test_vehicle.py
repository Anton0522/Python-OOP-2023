...
class TestVehicle(TestCase):
    ...
    def test_correct_initializing(self):
        ...
        self.assertEqual(175, self.vehicle.horse_power)
        self.assertEqual(Vehicle.DEFAULT_FUEL_CONSUMPTION, self.vehicle.fuel_consumption)

    def test_drive_car_without_enough_fuel_raises_ex(self):
        self.vehicle.fuel = 0
    ...
    def test_drive_car_with_enough_fuel_expect_decrease(self):
    ...
    def test_refuel_correct_fuel_increase(self):
        self.vehicle.fuel -=1
        self.vehicle.refuel(1)
        self.assertEqual(20.5, self.vehicle.fuel)
    ...
    def test_correct__str__method(self):
        ...
        expected = f"The vehicle has 175 " \
